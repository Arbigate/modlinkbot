    ...
    async def on_message(self, message):
        ...
        for query in queries:
            ...
            if query.lower() == "sos":
                ...
                exceptions_embed.set_footer(text="If you have any issues with this bot, please message Arbigate#6162. For the source code, use {source}")
            ...
            if query.lower() in exceptions.keys():
                ...
                exceptions_embed.add_field(name="Special Edition", value = '[' + query.title() + ']' + '(' + exceptions[query.lower()] + ')')
                exceptions_embed.set_footer(text="If you have any issues with this bot, please message Arbigate#6162. For the source code, use {source}")
                await message.channel.send(embed=exceptions_embed)
                continue
            ...
            if modlink is not None and le_modlink is not None:
                ...
                embed.add_field(name="Special Edition", value = '[' + modlink["name"] + '](https://www.nexusmods.com' + modlink["url"]+ ')')
                embed.add_field(name="Legendary Edition", value = '[' + le_modlink["name"] + '](https://www.nexusmods.com' + le_modlink["url"]+ ')')
                embed.set_footer(text="If you have any issues with this bot, please message Arbigate#6162. For the source code, use {source}")
                ...
                await message.channel.send('There were no results for: "' + query + '"')
